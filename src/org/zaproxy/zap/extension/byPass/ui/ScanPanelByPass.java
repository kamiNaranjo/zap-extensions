...
import org.zaproxy.zap.view.ScanStatus;
	...
	public abstract class ScanPanelByPass extends AbstractPanel {
		...
		private  void initialize(ImageIcon icon) {
	        ...
	        scanStatus = new ScanStatus(icon, ExtensionByPass.getMessageString("title.windows.ByPass"));
	...
	*/
	...
	/*	private JButton getStartScanButton() {
			if (startScanButton == null) {
				...
				startScanButton.setIcon(new ImageIcon(ScanPanelByPass.class.getResource("/resource/icon/16/131.png")));
	...
	/*	private JButton getStopScanButton() {
			if (stopScanButton == null) {
				...
				stopScanButton.setIcon(new ImageIcon(ScanPanelByPass.class.getResource("/resource/icon/16/142.png")));
		...
		private JToggleButton getPauseScanButton() {
			if (pauseScanButton == null) {
				...
				pauseScanButton.setIcon(new ImageIcon(ScanPanelByPass.class.getResource("/resource/icon/16/141.png")));
				pauseScanButton.setRolloverIcon(new ImageIcon(ScanPanelByPass.class.getResource("/resource/icon/16/141.png")));
				pauseScanButton.setSelectedIcon(new ImageIcon(ScanPanelByPass.class.getResource("/resource/icon/16/131.png")));
				pauseScanButton.setRolloverSelectedIcon(new ImageIcon(ScanPanelByPass.class.getResource("/resource/icon/16/131.png")));
		...
		private JButton getOptionsButton() {
			if (optionsButton == null) {
				...
				optionsButton.setIcon(new ImageIcon(ScanPanelByPass.class.getResource("/resource/icon/16/041.png")));
...
*/
		...
		protected abstract void switchView(ByPassTableModel model);
